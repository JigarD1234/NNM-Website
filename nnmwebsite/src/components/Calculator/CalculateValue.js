export function CalculateValues(quantityInput , priceInput , brokerageInput , minimumInput , exchangeInput ,calculateTable){
    ...
    if(calculateTable ===1 ){
        stampDuty = Number(((0.01/100)*turnover).toFixed(2))
    ...
    const totalCharges = (brokerage+STTtotal+stampDuty+sebiFees+ipft+transCharge+gst).toFixed(2)
    // const totalChargesSell = (brokerage+STTtotal+stampDutySell+sebiFees+ipft+transCharge+gst).toFixed(2)
    // console.log(calculateTable)
